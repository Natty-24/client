             ...
             <div className="hidden md:flex justify-between items-center gap-5">
               <div className="">
                <button onClick={toggleDarkMode}>
                  { isDarkMode ? (
                    <Sun className="cursor-pointer text-gray-500 sixe={24}" />
                  ) : (
                    <Moon className="cursor-pointer text-gray-500 sixe={24}" />
                  )}
                </button>
                </div>   
                <div className="relative">
                    <Bell className="cursor-pointer text-gray-500 sixe={24}" />
                ...
                <div className="flex  items-center gap-3 cursor-pointer">
                    ...
                    <span className="font-semibold">Seint Mery</span>
                </div>
             </div>            
             <Link href="/setting">
